...
//                    delete_numbers++;
    ...
    cout<<endl;
    cout<<" error_number : "<<error_numbers<<" , delete_numbers : "<<delete_numbers<<endl;
    return s;
}
...
//    DestroyDB(dbname, Options());
   ...
   // cout<<" after 500000"<<endl;
    TestGet(db,0 ,2500000);
   // cout<<" get 500000"<<endl;
//    sleep(300);
    uint64_t size = 0;
...
//  return RUN_ALL_TESTS();
    ...
    cout<<"-------------------Open Test ------------------"<<endl;
    TestPutAndGet("leveldb_test_benchmark_noSnapshot",false,true);
    //TestPutAndGet("leveldb_test_benchmark_useSnapshot",true);
   // TestMutilThread();
    return 0;
}
